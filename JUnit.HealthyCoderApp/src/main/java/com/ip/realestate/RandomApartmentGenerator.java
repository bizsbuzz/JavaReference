...
public class RandomApartmentGenerator {
    ...
    public Apartment generate() {
        ...
        BigDecimal pricePerSquareMeter = minPricePerSquareMeter.add((new BigDecimal(Math.random()).multiply(maxPricePerSquareMeter.subtract(minPricePerSquareMeter))));
